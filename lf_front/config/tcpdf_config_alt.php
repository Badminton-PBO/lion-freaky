 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'PBO VZW & Gentse BC');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'PBO VZW & Gentse BC');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Ploegopstelling');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by Lens Meyvaert \nwww.tcpdf.org");
