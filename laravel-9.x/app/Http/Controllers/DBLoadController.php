...
EOD;
    ...
    public function dbload($doLoad = 'true',$addTestClub = 'false') {
        ...
        $BASETEAM_CSV_URL=env('SITE_ROOT','http://localhost/pbo').'/data/fixed/2025-2026/basisopstellingen.csv';
        $FIXED_RANKING_CSV_URL=env('SITE_ROOT','http://localhost/pbo').'/data/fixed/2025-2026/indexen_spelers.csv';
        $LIGA_BASETEAM_CSV_URL=env('SITE_ROOT','http://localhost/pbo').'/data/fixed/2025-2026/liga_nationale_basisopstelling.csv';
...
70000002,"TESTCLUB 1G","TESTCLUB BC"
70000003,"TESTCLUB 1G","TESTCLUB BC"
70000019,"TESTCLUB 1G","TESTCLUB BC"
70000023,"TESTCLUB 1G","TESTCLUB BC"
70000020,"TESTCLUB 1D,"TESTCLUB BC"
70000021,"TESTCLUB 1D,"TESTCLUB BC"
70000032,"TESTCLUB 1D,"TESTCLUB BC"
70000033,"TESTCLUB 1D,"TESTCLUB BC"
EOD;
